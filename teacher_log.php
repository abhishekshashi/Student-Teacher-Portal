...
<body>
	<h1><a href="index.php"><button class = "student_loginb">HOME</button></a>KENDRIYA VIDYALAYA SANGATHAN</h1>
		...
		<main>
			...
			<div class = "login" align="center">
				...
				<form action = "login_submit_teacher.php" method = "post" name = "myForm" onsubmit="return ValidateEmail() || passwordvalid(this)">
					<br/>
					...
					<br/>
					<input class =  "loginbtn" type="submit" name="submit_teacher" value = "LOGIN">
  ...
  if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length) {
    ...
    return false;
				...
				<h5 style="color: white; font-size: 18px;">No account then ? <a href="teacher_reg.php" style="color: cyan">Register</a></h5>
			</div>
		</div>
