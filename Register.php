...
<body>
		...
		<main>
			...
			<div class = "register">
				<h3>REGISTER HERE AS STUDENT</h3>
				<form action = "reg_submit.php" method = "post" name = "myForm" class="form" onsubmit="return match(this) || ValidateEmail()">
					<br/>
					...
					<br/>
					<input class="email_id" type="text" name="class" placeholder="Class" >
					<br/> 
					<input class="email_id" type="text" name="age" placeholder="Age">
					<br/>
					<input class="email_id" type="text" name="mobile" placeholder="phone no.">
					<br/>
  ...
  if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length) {
    ...
    return false;
				...
				<h3>Already have a account ? <b> <a href="Login.php">Login</a> </b> </h3>
			</div>
			</div>
		</main>
